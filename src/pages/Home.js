    ...
    <div className="fade-in">
      ...
      <div style={{ borderBottom: '1px solid #f3f4f6' }}>
        ...
        >
          ...
          <p
            className="hero-p"
            style={{ fontSize: '1.15rem', color: '#6b7280', maxWidth: 560, lineHeight: 1.75, marginBottom: 40 }}
          >
          ...
          >
            {[['100%', 'Anonymous', '#0ea5e9'], ['24/7', 'Availability', '#ec4899'], ['Secure', 'Encrypted', '#818cf8']].map(
              ([n, l, c], i) => (
                <div
                  key={l}
                  style={{
