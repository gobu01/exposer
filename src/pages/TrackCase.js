    ...
    <div style={{ background: '#f9fafb', minHeight: 'calc(100vh - 68px)' }}>
      <div className="track-wrap fade-in" style={{ maxWidth: 660, margin: '0 auto', padding: '60px 24px 80px' }}>
        ...
        {report && (
          <div style={{ background: 'white', border: '1.5px solid #bae6fd', borderRadius: 16, padding: '24px', boxShadow: '0 4px 16px rgba(14,165,233,0.08)', marginBottom: 14 }} className="fade-in">
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 7, marginBottom: 22 }}>
              ...
              {report.category && (
                <span style={{ background: '#f9fafb', border: '1px solid #e5e7eb', borderRadius: 20, padding: '3px 10px', fontSize: '0.72rem', color: '#6b7280' }}>
            ...
            <div style={{ marginBottom: 18 }}>
              <div style={{ fontSize: '0.7rem', color: '#9ca3af', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: 10 }}>
                Case Progress
              </div>
                ...
                {STEPS.map((s, i) => {
                  ...
                  return (
                    <div key={s} style={{ flex: 1 }}>
                      <div
                        style={{
                          height: 5, borderRadius: 3, marginBottom: 7,
                          background: isDone ? 'linear-gradient(90deg,#0ea5e9,#818cf8)' : '#e5e7eb',
                          boxShadow: isCur ? '0 0 8px rgba(14,165,233,0.4)' : 'none',
                      ...
                      <div
                        style={{
                          ...
                          color: isDone ? '#0ea5e9' : '#9ca3af',
                          display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 2,
                        }}
                      >
                        {isDone && <IcoCheck />}{STEP_LBL[i]}
                      </div>
                    </div>
                  );
                })}
            ...
            {report.evidence?.length > 0 && (
              <div style={{ marginTop: 14 }}>
                <div style={{ fontSize: '0.72rem', color: '#6b7280', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: 8 }}>
                  Evidence Files
                </div>
        ...
        <div style={{ background: 'white', border: '1.5px solid #e5e7eb', borderRadius: 14, padding: '20px 24px', boxShadow: '0 2px 8px rgba(0,0,0,0.04)' }}>
          ...
          <p style={{ fontSize: '0.8rem', color: '#6b7280', marginBottom: 14, lineHeight: 1.6 }}>
            Submit a report first to receive your unique tracking ID.
          </p>
          <Link
            to="/report"
            style={{
