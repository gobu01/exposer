...
const IcoPhone = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
    <path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.95 12 19.79 19.79 0 01.87 3.4 2 2 0 012.85 1.22h3a2 2 0 012 1.72 12.84 12.84 0 00.7 2.81 2 2 0 01-.45 2.11L7.09 9c1.51 2.58 3.76 4.84 6.32 6.32l1.13-1.13a2 2 0 012.11-.45 12.84 12.84 0 002.81.7A2 2 0 0122 16.92z"/>
  </svg>
);
...
const CARDS = [
  {
    ...
    bg: '#e0f2fe',
    title: 'Our Mission',
    desc: "To empower every citizen to fight corruption safely and anonymously, ensuring no act of misconduct goes unreported due to fear of retaliation.",
  },
  {
    Icon: IcoScale,
    color: '#ec4899',
    ...
    desc: "Built in alignment with India's Whistle Blowers Protection Act 2014, Prevention of Corruption Act 1988, and the UN Convention Against Corruption.",
  },
  {
    Icon: IcoZap,
    color: '#10b981',
    ...
    desc: "Real-time database, anonymous submissions, encrypted file storage, and role-based access control on Google's Firebase platform.",
  },
  {
    Icon: IcoBook,
    color: '#818cf8',
    ...
    desc: "This portal is built as a college study project demonstrating full-stack web development with Firebase, React, and modern security practices.",
  },
];

const STACK = [
  'React 18', 'Firebase Auth', 'Cloud Firestore', 'Firebase Storage',
  'React Router v6', 'React Hook Form', 'Recharts', 'React Dropzone', 'React Toastify',
];
      ...
      <div className="about-wrap" style={{ maxWidth: 900, margin: '0 auto', padding: '56px 40px 72px' }}>
        ...
        <div style={{ background: 'white', border: '1.5px solid #e5e7eb', borderRadius: 16, padding: '24px', marginBottom: 20, boxShadow: '0 2px 8px rgba(0,0,0,0.04)' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
            {STACK.map(t => (
              <span key={t} style={{ background: '#f0f9ff', border: '1px solid #bae6fd', borderRadius: 20, padding: '4px 14px', fontSize: '0.8rem', color: '#0369a1', fontWeight: 500 }}>
                {t}
              </span>
            ))}
          </div>
